...
<head>
	...
	<title>Tarif Pengiriman Frozen Food</title>
</head>
<body>
<div class="kotak" align="center">
	<h1 class="display-4">Tarif Pengiriman Frozen Food</h1>
	<br><br>
	...
	<input type="number" name="margin" placeholder="Margin" min="20" max="40" required="" class="form-control col">
...
<?php 
	...
	if (isset($_POST['submit'])) {
		...
		mysqli_query($koneksi, "INSERT INTO frozen_food VALUES('','$asal','$tujuan','$vendor','$leadtime','$modal','$margin','$jual','$input_date')");
		...
		<?php } ?>
<hr class="container">
<a href="tabel_harga.php" class="btn btn-info">Tabel Frozen Food</a>
