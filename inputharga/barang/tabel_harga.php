...
$baca_harga = mysqli_query($koneksi, "SELECT * FROM harga_barang ORDER BY id DESC");
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../style/basic.css">
	<title>Tabel Harga Internal</title>
</head>
<body>

<div class="kotak" align="center">
<h1>Data Harga Tersedia</h1>
	<a href="index.php">Back To Input Harga</a>
		<br><br>
        ...
        ?>
				<tr>
					...
					<td><?php echo $row_harga['margin']; ?> %</td>
					<td>Rp. <?php echo $jual ?></td>
					<td><?php echo $row_harga['input_date']; ?></td>
					<td>
						<a href="update.php?id=<?php echo $row_harga['id'] ?>">Edit</a>
						|
