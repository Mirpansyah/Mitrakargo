...
$read_motor = mysqli_query($koneksi, "SELECT * FROM motor_sedang ORDER BY id ASC");
?>
...
<div class="bungkus">
	...
	<table align="center" id="mytable">
    	...
    	<td><?php echo $row['id']; ?></td>
	      ...
	      <td>
  		<a href="">Edit</a>
  		<a href="sdelete.php?sdelete=<?php echo $row['id']; ?>">Delete</a>
		</td>
		</tr>
		<?php } ?>
        <?php } ?>
