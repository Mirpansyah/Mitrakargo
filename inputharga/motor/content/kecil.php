<?php 
$read_motor = mysqli_query($koneksi, "SELECT * FROM motor_kecil ORDER BY id ASC");
?>
...
<div class="bungkus">
  ...
  <?php while ($row = mysqli_fetch_array($read_motor)){ ?>
      <tr>
	      ...
	      <td>
  					<a href="">Edit</a>
  					<a href="kdelete.php?kdelete=<?php echo $row['id']; ?>">Delete</a>
				</td>
			</tr>
    	<?php } ?>
        <?php } ?>
